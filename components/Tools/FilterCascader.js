...
const filteredOptions = categoriesTab.filter((e) => !selectedItems.includes(e));
...
return (
    ...
    <Select mode="multiple" placeholder="Filter by category" value={selectedItems} onChange={handleFilterChange} style={{ width: '100%'}}
